...
if duo == false then
	...
	_G.Color = Color3.fromRGB(167, 94, 155)
	...
	getgenv()['Check_Setting'] = function(Name)
		if not _G.Dis and not isfolder('XlationHUB SpecialEdition') then
			makefolder('XlationHUB SpecialEdition')
		end
		if not _G.Dis and not isfile('XlationHUB SpecialEdition/'..Name..'.json') then
			writefile('XlationHUB SpecialEdition/'..Name..'.json',JsonEncode(_G.Setting_table))
		end
	end
	getgenv()['Get_Setting'] = function(Name)
		if not _G.Dis and isfolder('XlationHUB SpecialEdition') and isfile('XlationHUB SpecialEdition/'..Name..'.json') then
			_G.Setting_table = JsonDecode(readfile('XlationHUB SpecialEdition/'..Name..'.json'))
	...
	if IKAI then
		...
		function library:Window(text,text2,text3,logo,keybind)
			...
			ToggleImgUi.Image = "rbxassetid://12232915631"
			...
			ImageLabelfps.Image = "rbxassetid://12232915631"
			...
			ImageLabeltime.Image = "rbxassetid://12232915631"
	...
	local win = library:Window("Xlation",[[Hub]],[[Special Edition]],"12232915631",Enum.KeyCode.RightControl)           --NameHUB
	...
	if Old_World then
		...
		Island_Tab:Button("Pirate Starter", function()
			TP2(CFrame.new(1042.1501464844, 16.299360275269, 1444.3442382813))
		end)

		Island_Tab:Button("Marine Starter", function()
			TP2(CFrame.new(-2599.6655273438, 6.9146227836609, 2062.2216796875))
		end)

		Island_Tab:Button("Marine Fortless", function()
	...
	local Bartlio_ST = Status_Tab:LabelP("âŒ : Quest Bartlio")
	local Open_Don_Swan_ST = Status_Tab:LabelP("âŒ : Quest Open Don Swan")
	local Phoenix_Awaken_ST = Status_Tab:LabelP("âŒ : Quest Phoenix Awaken")
	local Observation_Haki_ST = Status_Tab:LabelP("âŒ : Quest Observation Haki")
	local Observation_Haki_V2_ST = Status_Tab:LabelP("âŒ : Quest Observation Haki V2")
	Status_Tab:Label("Status Legendary Sword")
	local ST_Shisui = Status_Tab:LabelP("âŒ : Shisui")
	local ST_Saddi = Status_Tab:LabelP("âŒ : Saddi")
	local ST_Wando = Status_Tab:LabelP("âŒ : Wando")
	...
	Hop_Tab:Label("Server")
	Hop_Tab:Button("Hop Server",function()
		HopServer()
	end)
	function HopServer()
	...
	Hop_Tab:Button("Hop Low Server",function()
		HopLowServer()
	end)
	Hop_Tab:Button("Rejoin Server",function()
		_G.TP_Ser = true
		wait(1)
		game:GetService("TeleportService"):Teleport(game.PlaceId)
		wait(50)
